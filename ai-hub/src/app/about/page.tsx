...
const values = [
  {
    ...
    description: "Every tool, company, and resource is hand-selected and verified. We prioritize quality and accuracy over volume.",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description: "We are not affiliated with any AI company or vendor. Our goal is to give you honest, balanced information to make informed decisions.",
  },
  {
    icon: Globe,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        ...
        <section className="text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Found an error? Know a tool we're missing? Want to contribute a case study?
          </p>
          <Link
            href="/contribute"
