...
export const metadata: Metadata = {
  title: "About AIHub",
  description: "AIHub is the independent, curated AI knowledge platform - covering 125+ tools, 62+ companies, 23 compliance frameworks, and 51+ case studies.",
  alternates: { canonical: `${BASE_URL}/about` },
  openGraph: { title: "About AIHub - The AI Knowledge Platform", description: "AIHub is the independent, curated AI knowledge platform - 125+ tools, 62+ companies, 23 compliance frameworks, and 51+ case studies.", url: `${BASE_URL}/about`, type: "website" },
};
...
const sections = [
  { icon: Zap,        label: "AI Tools Directory", href: "/tools",        description: "125+ tools across every category" },
  { icon: TrendingUp, label: "Case Studies",        href: "/case-studies", description: "51 real-world implementations with measured outcomes" },
  { icon: Shield,     label: "Compliance",          href: "/compliance",   description: "23 regulatory frameworks explained clearly" },
  { icon: BookOpen,   label: "Learn AI",             href: "/learn",        description: "87 curated courses, videos, and certifications" },
];
