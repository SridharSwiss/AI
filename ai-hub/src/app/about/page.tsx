...
export const metadata: Metadata = {
  title: "About AIHub",
  description: "AIHub is the independent, curated AI knowledge platform - covering 107+ tools, 39+ companies, 16 compliance frameworks, and 25+ case studies.",
  alternates: { canonical: `${BASE_URL}/about` },
  openGraph: { title: "About AIHub - The AI Knowledge Platform", description: "AIHub is the independent, curated AI knowledge platform - 107+ tools, 39+ companies, 16 compliance frameworks, and 25+ case studies.", url: `${BASE_URL}/about`, type: "website" },
};
