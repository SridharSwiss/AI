...
export const metadata: Metadata = {
  ...
  description:
    "AIHub is the world's most complete AI knowledge platform: compare 128+ AI tools, explore 65 companies, navigate EU AI Act compliance, and access structured learning paths — all in one place.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Compare 128+ AI tools, explore AI companies, navigate EU AI Act compliance, and access learning paths — all curated in one platform.",
    url: BASE_URL,
    locale: "en_US",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Compare 128+ AI tools, explore AI companies, navigate EU AI Act compliance, and access learning paths — all in one platform.",
...
const orgJsonLd = {
  ...
  description:
    "AIHub is the world's most complete AI knowledge platform: 128+ tools, 65 companies, EU AI Act compliance guides, structured learning paths, and consulting playbooks.",
  foundingDate: "2024",
  sameAs: [
