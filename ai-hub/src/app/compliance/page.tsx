...
const jsonLd = {
  ...
  name: "AI Compliance & Regulatory Frameworks", description: "Comprehensive guides to 17 AI regulatory frameworks.",
...
export default function CompliancePage() {
  return (
    <>
      ...
      <PageHeader accent="rose" eyebrow="Compliance & Governance" title="AI Regulatory Landscape" description="Navigate AI regulations, governance frameworks, and compliance requirements across 17 jurisdictions.">
