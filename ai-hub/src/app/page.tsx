...
export const metadata: Metadata = {
  ...
  title: "AIHub — Compare 118+ AI Tools, Companies & EU AI Act Compliance (2026)",
  description:
    "AIHub is the world's most complete AI reference platform. Compare ChatGPT, Claude, Gemini and 107+ AI tools side-by-side. Explore 54 AI companies with funding data. Navigate EU AI Act compliance. Updated June 2026.",
  alternates: { canonical: BASE_URL },
  openGraph: {
    title: "AIHub — Compare 118+ AI Tools, Companies & EU AI Act Compliance (2026)",
    description:
      "Compare ChatGPT, Claude, Gemini and 107+ AI tools. Explore 54 AI companies with funding data. Navigate EU AI Act compliance. Updated June 2026.",
    url: BASE_URL,
    type: "website",
