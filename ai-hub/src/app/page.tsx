...
export const metadata: Metadata = {
  ...
  title: "AI Hub Switzerland Directory of 142+ AI Tools, Companies and Compliance",
  description:
    "Compare 142+ AI tools side by side, explore 82 AI companies, and navigate EU AI Act compliance in one independent, daily-updated AI platform.",
  alternates: { canonical: BASE_URL },
  openGraph: {
    title: "AI Hub Switzerland Directory of 142+ AI Tools, Companies and Compliance",
    description:
      "Compare 142+ AI tools, explore 82 AI companies, and navigate EU AI Act compliance — one independent, daily-updated AI platform.",
    url: BASE_URL,
    type: "website",
