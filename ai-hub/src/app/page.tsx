...
export const metadata: Metadata = {
  ...
  description:
    "AIHub is the world's most complete AI reference platform. Compare ChatGPT, Claude, Gemini and 137+ AI tools side-by-side. Explore 73 AI companies with funding data. Navigate EU AI Act compliance. Updated daily.",
  alternates: { canonical: BASE_URL },
  openGraph: {
    title: "AIHub — Compare 137+ AI Tools, Companies & EU AI Act Compliance (2026)",
    description:
      "Compare ChatGPT, Claude, Gemini and 137+ AI tools. Explore 73 AI companies with funding data. Navigate EU AI Act compliance. Updated daily.",
    url: BASE_URL,
    type: "website",
