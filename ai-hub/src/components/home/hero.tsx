  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col items-center justify-center overflow-hidden noise">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        {/* Radial glows — light source from upper-center */}
      ...
      <div className="container-site py-24 text-center">
        ...
        {/* Subtitle — enters 300ms after eyebrow */}
        ...
        <div className="animate-fade-up delay-400 flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          ...
          <Link href="/tools">
            <Button
              variant="outline"
              size="xl"
              className="gap-2.5 w-full sm:w-auto btn-press bg-background/60 backdrop-blur"
            >
              Browse AI Tools
        ...
        {/* Stats — enters 600ms after eyebrow */}
        <div className="animate-fade-up delay-500">
          <div className="inline-grid grid-cols-3 sm:grid-cols-5 gap-px rounded-2xl overflow-hidden border border-border/50 bg-border/30 shadow-card mb-16">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="flex flex-col items-center justify-center px-6 py-5 bg-background/90 backdrop-blur-sm"
              >
                <div className="text-2xl sm:text-3xl font-bold gradient-text mb-0.5 tracking-tight">
                  {stat.value}
                </div>
        ...
        {/* Highlights — enters 700ms after eyebrow */}
