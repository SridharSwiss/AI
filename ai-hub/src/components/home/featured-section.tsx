...
const sectionNav = [
  ...
  },
  {
    ...
    body: "69 real deployments with measured outcomes — cost saved, time reduced, accuracy gained — across healthcare, finance, and more.",
    stat: "69 case studies",
  },
  {
