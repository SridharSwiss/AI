...
const sectionNav = [
  {
    ...
    body: "Filter by category, pricing model, and use case. Freemium to enterprise — 137 tools across 15 categories with verified specs.",
    stat: "137 tools · 15 categories",
  },
  {
    icon: Building2, label: "Companies",          href: "/companies",
    iconCls: "bg-blue-500/10 dark:bg-blue-500/[0.18] text-blue-500",
    desc: "73 vendors profiled.",
  ...
  },
  {
    ...
    body: "65 real deployments with measured outcomes — cost saved, time reduced, accuracy gained — across healthcare, finance, and more.",
    stat: "65 case studies",
  },
  {
...
const personas = [
  { role: "Builder", icon: Code2, desc: "Compare APIs, pricing, and capabilities across 137 tools.", href: "/tools", color: "border-violet-500", barColor: "bg-violet-500" },
  { role: "Executive", icon: BarChart3, desc: "ROI evidence and vendor comparison from 65 case studies.", href: "/case-studies", color: "border-blue-500", barColor: "bg-blue-500" },
  { role: "Compliance Officer", icon: Shield, desc: "27 frameworks mapped. Deadlines tracked.", href: "/compliance", color: "border-amber-500", barColor: "bg-amber-500" },
  { role: "Learner", icon: GraduationCap, desc: "98 resources from beginner to production ML.", href: "/learn", color: "border-emerald-500", barColor: "bg-emerald-500" },
];
...
export function FeaturedSection() {
  return (
    <div className="container-site section-gap space-y-24">
      ...
      <ScrollReveal>
        <SectionHeading eyebrow="Featured Tools" eyebrowIcon={Sparkles} title="Popular AI tools right now" viewAllHref="/tools" viewAllLabel="View all 137+ tools" />
        <ScrollReveal stagger>
