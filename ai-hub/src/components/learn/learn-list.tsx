    ...
    <div>
      ...
      {filtered.length === 0 ? (
        ...
        <div className="glass-card rounded-2xl overflow-hidden divide-y divide-white/[0.06]">
          {/* Header */}
          <div className="hidden md:grid grid-cols-[40px_220px_1fr_140px_130px_80px] gap-4 items-center px-5 py-2 bg-white/[0.03] text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
            <div />
            <div>Resource</div>
            <div>Description</div>
            <div>Tags</div>
          ...
          {filtered.map((r) => {
            ...
            return (
              <a
                ...
                className="group grid grid-cols-[40px_1fr_auto] md:grid-cols-[40px_220px_1fr_140px_130px_80px] gap-3 md:gap-4 items-center px-4 md:px-5 py-3.5 hover:bg-white/[0.04] transition-colors duration-150"
              >
                {/* Icon */}
