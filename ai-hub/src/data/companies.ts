...
export const companies: CompanyData[] = [
  {
    ...
    slug: "openai",
    name: "OpenAI",
    description: "OpenAI is an AI research and deployment company with a mission to ensure artificial general intelligence benefits all of humanity. Developer of the GPT series, ChatGPT, DALL-E, Sora, and the o-series reasoning models. The company is transitioning to a public benefit corporation (PBC) structure.",
    founded: 2015,
    hq: "San Francisco, CA",
    stage: "Private",
    focus: "Foundation Models",
    products: ["ChatGPT", "GPT-4.1", "GPT-4o", "o3", "o4-mini", "DALL-E 3", "GPT Image 1", "Sora", "Whisper", "OpenAI API", "Operator"],
    tags: ["LLM", "Research", "Consumer", "API", "Reasoning", "Agents"],
    website: "https://openai.com",
    featured: true,
    notableModels: ["GPT-4.1", "GPT-4o", "o3", "o4-mini", "Sora", "Whisper"],
    funding: "$40B+ raised, $300B valuation (Mar 2025 SoftBank round)",
    keyPeople: ["Sam Altman (CEO)", "Greg Brockman (President, returned 2025)", "Kevin Weil (Chief Product Officer)", "Chris Lehane (Chief Global Affairs)"],
    history: "Founded in 2015 as a nonprofit by Elon Musk, Sam Altman, and others. Transitioned to a capped-profit model in 2019. Partnership with Microsoft ($13B total). ChatGPT launched Nov 2022, reaching 100M users in 60 days. GPT-4 Mar 2023. Sam Altman briefly fired Nov 2023, rehired within 5 days. GPT-4o May 2024. o1 reasoning model Sep 2024. $6.6B funding at $157B valuation Oct 2024. o3 + GPT-4.1 Apr 2025. $40B from SoftBank at $300B valuation Mar 2025. Announcing PBC conversion 2025.",
    employees: "~4,000",
    models: [
      {
        name: "o3",
    ...
    financials: {
      totalFunding: "$40B+",
      latestValuation: "$300B (Mar 2025, SoftBank)",
      revenue: "$12.7B ARR (run rate, Mar 2025)",
      revenueYear: "2025",
      profitStatus: "Not yet profitable (heavy compute spend)",
      employees: "~4,000",
      annualRevenueGrowth: ">200% YoY",
      keyInvestors: ["Microsoft", "SoftBank", "Thrive Capital", "NVIDIA", "Tiger Global", "Sequoia Capital", "Apple (rumored deal)"],
      fundingRounds: [
        ...
        { date: "Mar 2025", round: "SoftBank Round", amount: "$40B", investors: ["SoftBank"] },
      ],
    },
    milestones: [
      ...
      { date: "Dec 2024", event: "o3 model unveiled; GPT-4.5 preview in development" },
      { date: "Feb 2025", event: "GPT-4.5 (preview) released - largest dense model trained" },
      { date: "Mar 2025", event: "SoftBank invests $40B at $300B valuation" },
      { date: "Apr 2025", event: "o3, o4-mini, GPT-4.1 family (1M context) released; ChatGPT reaches 500M WAU" },
      { date: "May 2025", event: "GPT Image 1 (successor to DALL-E 3); Operator agents in ChatGPT" },
    ],
  ...
  },
  {
    ...
    slug: "anthropic",
    name: "Anthropic",
    description: "Anthropic is an AI safety company building reliable, interpretable, and steerable AI systems. Creator of the Claude family of models with a focus on Constitutional AI and long-context understanding. Reached $61.5B valuation in 2025 with Claude 4 series as frontier coding and reasoning models.",
    founded: 2021,
    hq: "San Francisco, CA",
    stage: "Private",
    focus: "AI Safety",
    products: ["Claude 4 Opus", "Claude 4 Sonnet", "Claude 3.7 Sonnet", "Claude 3.5 Haiku", "Claude API", "Claude.ai", "Claude Code (CLI)"],
    tags: ["Safety", "LLM", "Research", "Constitutional AI", "Coding", "Agents"],
    website: "https://anthropic.com",
    featured: true,
    notableModels: ["Claude 4 Opus", "Claude 4 Sonnet", "Claude 3.7 Sonnet", "Claude 3.5 Haiku"],
    funding: "$12.7B+ raised, $61.5B valuation (2025)",
    keyPeople: ["Dario Amodei (CEO)", "Daniela Amodei (President)", "Chris Olah (Research)", "Mike Krieger (Chief Product)"],
    history: "Founded in 2021 by former OpenAI researchers including Dario and Daniela Amodei. Known for Constitutional AI. Amazon invested $4B (2023) then expanded to $8B total (2024). Claude 3 family Mar 2024. Claude 3.5 Sonnet Jun 2024. Computer Use GA Oct 2024. Claude 3.7 Sonnet (extended thinking/hybrid reasoning) Feb 2025. $61.5B valuation Mar 2025 (Google, Amazon, Spark). Claude 4 Opus & Sonnet May 2025 - lead SWE-bench at 72.5% and top coding benchmarks.",
    employees: "~1,600",
    models: [
      {
    ...
    financials: {
      totalFunding: "$12.7B+",
      latestValuation: "$61.5B (Mar 2025)",
    ...
    milestones: [
      ...
      { date: "Nov 2024", event: "Claude 3.5 Haiku launched; Amazon expands to $8B total investment" },
      { date: "Feb 2025", event: "Claude 3.7 Sonnet - extended thinking/hybrid reasoning model" },
      { date: "Mar 2025", event: "$61.5B valuation achieved; Claude Code CLI released for developers" },
      { date: "May 2025", event: "Claude 4 Opus & Sonnet - #1 on SWE-bench (72.5%), top frontier coding models" },
    ],
  ...
  },
  {
    ...
    featured: true,
    notableModels: ["Gemini 2.5 Pro", "Gemini 2.5 Flash", "Gemma 3", "AlphaFold 3"],
    keyPeople: ["Demis Hassabis (CEO)", "Shane Legg (Chief AGI Scientist)", "Koray Kavukcuoglu (CTO)"],
    history: "DeepMind founded in London in 2010, acquired by Google in 2014. Google Brain founded separately in 2011. Merged into Google DeepMind in April 2023. Gemini 2.5 Pro (Mar 2025) topped LMArena and multiple coding benchmarks. AlphaFold 3 won the Nobel Chemistry Prize (Oct 2024) for Demis Hassabis and John Jumper.",
    employees: "~5,000",
    models: [
      {
        name: "Gemini 2.5 Pro",
        ...
        description: "#1 on LMArena and SWE-bench (63.8%) at launch. Best reasoning + coding + multimodal.",
        benchmarks: [
          { name: "MMLU", score: "91.4%" },
          { name: "HumanEval", score: "97.0%" },
          { name: "SWE-bench", score: "63.8%" },
          { name: "GPQA Diamond", score: "84.0%" },
        ],
      },
      {
        ...
        description: "Best speed-to-intelligence ratio. Thinking mode for complex tasks. Ultra-fast with native multimodal.",
        benchmarks: [
          { name: "MMLU", score: "89.0%" },
          { name: "HumanEval", score: "96.0%" },
        ],
      },
      {
      ...
      },
      {
        ...
        releaseDate: "Mar 2025",
        openSource: true,
        description: "#1 single-GPU open model. Outperforms Llama 3.3 70B at half the size. Multimodal image input.",
        benchmarks: [
          { name: "MMLU", score: "78.6%" },
          { name: "HumanEval", score: "86.0%" },
        ],
      },
      {
        name: "AlphaFold 3",
        type: "Scientific",
        releaseDate: "May 2024",
        description: "Predicts 3D structure of all life's molecules - proteins, DNA, RNA, ligands. Nobel Prize 2024.",
      },
      {
        name: "Imagen 3",
        type: "Image Gen",
      ...
      },
      {
        ...
        type: "Video Gen",
        releaseDate: "Dec 2024",
        description: "State-of-the-art text-to-video model. Cinematic quality up to 4K, 2 minutes. Available in Gemini Advanced.",
      },
    ],
    financials: {
      stockSymbol: "GOOGL",
      marketCap: "$2.3T (Alphabet, Jun 2025)",
      revenue: "Part of Alphabet - FY2024 total revenue: $350B; Q1 2025: $90B (26% YoY)",
      profitStatus: "Profitable (Alphabet net income $100B+ FY2024)",
      employees: "~5,000 (DeepMind/Google Brain)",
    ...
    milestones: [
      ...
      { date: "Feb 2024", event: "Gemini 1.5 Pro - 1M/2M token context window" },
      { date: "May 2024", event: "AlphaFold 3 - predicts structure of all molecules" },
      { date: "Oct 2024", event: "Nobel Prize in Chemistry awarded to Demis Hassabis & John Jumper for AlphaFold" },
      { date: "Dec 2024", event: "Gemini 2.0 Flash and Veo 2 released" },
      { date: "Mar 2025", event: "Gemini 2.5 Pro - #1 on LMArena, SWE-bench, GPQA; Gemma 3 open-source" },
      { date: "May 2025", event: "Gemini 2.5 Flash - best speed/intelligence; Project Astra multimodal agent advances" },
    ],
  ...
  },
  {
    ...
    featured: true,
    notableModels: ["Llama 4 Scout", "Llama 4 Maverick", "Llama 4 Behemoth", "Llama 3.3 70B"],
    keyPeople: ["Yann LeCun (Chief AI Scientist)", "Joelle Pineau (VP AI Research)", "Ahmad Al-Dahle (VP Gen AI)"],
    history: "FAIR (Fundamental AI Research) established in 2013 with Yann LeCun as chief scientist. Released Llama in 2023, setting the open-source AI standard. Llama 4 (Apr 2025) introduced MoE architecture with native multimodal and 10M context window. Meta spending $65B on AI infrastructure in 2025.",
    employees: "~2,500 (FAIR; Meta total: 72,000+)",
    models: [
      {
    ...
    financials: {
      stockSymbol: "META",
      marketCap: "$1.7T (Jun 2025)",
      revenue: "FY2024: $164B total Meta revenue; Q1 2025: $42.3B (16% YoY)",
    ...
    milestones: [
      ...
      { date: "Dec 2024", event: "Llama 3.3 70B - 405B performance at 70B size" },
      { date: "Apr 2025", event: "Llama 4 Scout & Maverick - MoE architecture, native multimodal, 10M context" },
      { date: "2025", event: "Llama 4 Behemoth (405B+ MoE) in training; Meta commits $65B to AI infrastructure" },
    ],
  ...
  },
  {
    ...
    funding: "€1.1B raised, €6B valuation (2024); exploring €2B+ round in 2025",
    keyPeople: ["Arthur Mensch (CEO)", "Guillaume Lample", "Timothée Lacroix"],
    history: "Founded in April 2023 by former DeepMind and Meta researchers. Mistral 7B Sep 2023 - immediately tops open-source. Mixtral 8x7B Dec 2023 - MoE breakthrough. €600M Series B Jun 2024. Mistral Small 3 (24B, Jan 2025) best small model efficiency. Codestral 2501 (Jan 2025) leading code model. Le Chat consumer app growing. Mistral Medium 3 and Large 3 (2025) with improved performance. Partnership discussions with European governments for AI sovereignty.",
    employees: "~600",
    models: [
      {
  ...
  },
  {
    ...
    funding: "$445M raised, $5.5B valuation (2024); merger with Aleph Alpha announced 2025",
    keyPeople: ["Aidan Gomez (CEO)", "Nick Frosst", "Ivan Zhang"],
    history: "Founded in 2019 by Aidan Gomez (co-author of the Transformer paper), Nick Frosst, and Ivan Zhang. Strong in enterprise RAG and multilingual. Raised $500M at $5.5B in 2024. Merger with European AI company Aleph Alpha announced 2025 to form a larger European enterprise AI entity. Command R+ remains top enterprise RAG model.",
    employees: "~1,000",
    models: [
      {
        name: "Command R+",
  ...
  },
  {
    ...
    funding: "$545M+ raised, $3B valuation (Oct 2024)",
    keyPeople: ["Cristóbal Valenzuela (CEO)", "Anastasis Germanidis (CTO)"],
    history: "Founded in 2018 as a creative tools company. Co-developed original Stable Diffusion. Gen-1 Mar 2023. Gen-2 Nov 2023. $141M raise at $1.5B (Google, NVIDIA) Jun 2023. Gen-3 Alpha Jun 2024 - cinematic quality, used in Hollywood. $308M raise at $3B Oct 2024. Gen-4 Mar 2025 - consistent characters, multi-shot storytelling, 4K up to 16s. Used in major film productions.",
    models: [
      {
        name: "Gen-4",
        type: "Video Gen",
        releaseDate: "Mar 2025",
        description: "Consistent characters across scenes, multi-shot storytelling, 4K up to 16s. Used in Hollywood productions.",
      },
      {
        name: "Gen-3 Alpha",
        type: "Video Gen",
      ...
      },
      {
        ...
        type: "Video Gen",
        releaseDate: "Aug 2024",
        description: "5× faster variant of Gen-3 Alpha for rapid iteration.",
      },
    ],
    financials: {
      totalFunding: "$545M+",
      latestValuation: "$3B (Oct 2024)",
      revenue: "~$100M ARR (2025 est.)",
      employees: "~350",
      profitStatus: "Pre-profit",
      keyInvestors: ["Google", "Salesforce Ventures", "Nvidia", "Felicis Ventures", "General Atlantic"],
      fundingRounds: [
        ...
        { date: "Oct 2024", round: "Series E", amount: "$308M", investors: ["General Atlantic", "Google", "$3B valuation"] },
      ],
    },
    competitors: ["Sora (OpenAI)", "Kling (Kuaishou)", "Veo 2 (Google)", "Pika Labs", "HeyGen"],
  },
  {
    id: "elevenlabs",
    slug: "elevenlabs-co",
    ...
    funding: "$430M+ raised, $11B valuation (2025)",
    keyPeople: ["Mati Staniszewski (CEO)", "Piotr Dąbkowski (CTO)"],
    history: "Founded in 2022 by two Polish entrepreneurs. Reached unicorn status Jan 2024 ($80M Series B, $1.1B valuation). $180M Series C at $3.3B Jan 2025. Eleven v3 (May 2025) - most expressive TTS with emotions, pacing, emphasis. $330M ARR. $11B valuation target in 2025.",
    models: [
      {
        name: "Eleven v3",
        type: "Audio",
    ...
    financials: {
      totalFunding: "$430M+",
      latestValuation: "$11B (2025 target)",
      revenue: "$330M ARR (2025)",
      employees: "~400",
      profitStatus: "Growing rapidly toward profitability",
      keyInvestors: ["a16z", "ICONIQ Growth", "Nat Friedman", "Daniel Gross", "SV Angel"],
      fundingRounds: [
        ...
        { date: "2025", round: "Series D", amount: "$250M+", investors: ["$11B valuation target"] },
      ],
    },
    competitors: ["OpenAI TTS", "Google Cloud TTS", "Microsoft Azure TTS", "Suno (music)"],
  },
  {
    id: "perplexity-ai",
    slug: "perplexity-ai",
    ...
    funding: "$900M+ raised, $18B valuation (Mar 2025)",
    keyPeople: ["Aravind Srinivas (CEO)", "Denis Yarats (CTO)", "Johnny Ho", "Andy Konwinski"],
    history: "Founded in 2022 by former Google, OpenAI, and Meta researchers. Grew from 1M to 100M+ MAU. Backed by Jeff Bezos, NVIDIA, SoftBank. Sonar search-optimized LLM family. Perplexity Assistant (agentic) Jan 2025. $18B valuation Mar 2025. Revenue on track for $1B ARR.",
    financials: {
      totalFunding: "$900M+",
      latestValuation: "$18B (Mar 2025)",
      revenue: "$100M+ ARR (2025, growing fast)",
      employees: "~200",
      profitStatus: "Pre-profit, strong revenue growth",
      keyInvestors: ["Jeff Bezos", "NVIDIA", "SoftBank", "IVP", "NEA", "Databricks", "Institutional Venture Partners"],
      fundingRounds: [
        { date: "2024", round: "Series B", amount: "$73.6M", investors: ["IVP", "NVIDIA", "Jeff Bezos"] },
        { date: "Jan 2025", round: "Series D", amount: "$500M", investors: ["SoftBank", "$9B valuation"] },
        { date: "Mar 2025", round: "Series E", amount: "$500M+", investors: ["$18B valuation"] },
      ],
    },
    competitors: ["Google Search", "Bing AI / Copilot", "ChatGPT Search", "You.com"],
  },
  {
    id: "scale-ai",
    slug: "scale-ai",
  ...
  },
  {
    ...
    slug: "xai",
    name: "xAI",
    description: "xAI is Elon Musk's AI company focused on building AI for the benefit of humanity with an emphasis on scientific discovery. Develops the Grok model family, with unique real-time X data access. Grok 3 launched Feb 2025 trained on the 200K-GPU Colossus supercluster. In Jun 2025, xAI merged with X (formerly Twitter) in a $50B deal.",
    founded: 2023,
    hq: "Memphis, TN / San Francisco, CA",
    stage: "Private",
    focus: "Foundation Models",
    products: ["Grok 3", "Grok 4", "Grok 3 mini", "Aurora", "Colossus Supercluster", "grok.com"],
    tags: ["LLM", "Real-time", "Research", "Consumer", "Reasoning", "Supercompute"],
    website: "https://x.ai",
    featured: false,
    notableModels: ["Grok 3", "Grok 4", "Grok-2", "Grok-1 (open-source)"],
    funding: "$12B+ raised, $50B+ valuation (post X merger)",
    keyPeople: ["Elon Musk (CEO)", "Igor Babuschkin (co-founder)", "Tony Wu", "Dan Hendrycks (safety)"],
    history: "Founded in July 2023 by Elon Musk. Grok-1 open-sourced Mar 2024 (314B MoE, Apache 2.0). Grok-2 Aug 2024. Built Colossus - world's largest AI training cluster (200K GPUs) in Memphis. Grok 3 (Feb 2025) trained on Colossus, hit #1 on AIME math at launch. grok.com launched free access. Grok 4 released Jun 2025. xAI merged with X (Twitter) in $50B deal Jun 2025.",
    employees: "~2,000",
    models: [
      {
        name: "Grok 4",
        ...
        description: "Latest frontier model. Advanced reasoning and scientific problem-solving.",
        benchmarks: [
          { name: "MMLU", score: "93%+" },
          { name: "AIME", score: "Top tier" },
        ],
      },
      {
        name: "Grok 3",
        ...
        description: "Trained on 200K-GPU Colossus cluster. #1 on AIME math at launch. DeepSearch + Think mode.",
        benchmarks: [
          { name: "MMLU", score: "92.7%" },
          { name: "AIME 2025", score: "#1 at launch" },
          { name: "MATH", score: "89%" },
        ],
      },
      {
        ...
        contextWindow: "128K",
        releaseDate: "Feb 2025",
        description: "Fast reasoning model. Strong math and code at lower cost. Think mode available.",
      },
      {
        name: "Grok-2",
        type: "Multimodal",
        contextWindow: "128K",
        releaseDate: "Aug 2024",
        description: "Previous flagship with real-time X data access and Aurora image generation.",
        benchmarks: [
      ...
      },
      {
        ...
        type: "Image Gen",
        releaseDate: "Aug 2024",
        description: "Text-to-image model integrated into Grok on X platform.",
      },
    ],
    financials: {
      totalFunding: "$12B+",
      latestValuation: "$50B+ (post X merger, Jun 2025)",
      employees: "~2,000",
      profitStatus: "Pre-profit (investing heavily in compute)",
